...
function(subdep_add DEP_NAME)
    ...
    if(EXISTS "${FLUXINS_SOURCE_DIR}/deps/${DEP_NAME}/.git")
        message(STATUS "Adding dependency '${DEP_NAME}' from '${FLUXINS_SOURCE_DIR}/deps/${DEP_NAME}' (initialized git submodule)")
        add_subdirectory("${FLUXINS_SOURCE_DIR}/deps/${DEP_NAME}" ${DEP_NAME})
        return()
    endif()
    ...
    message(STATUS "Initializing git submodule for '${DEP_NAME}' at '${FLUXINS_SOURCE_DIR}/deps/${DEP_NAME}'")
    execute_process(
